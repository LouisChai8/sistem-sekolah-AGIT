        ...
        <div class="mt-3 border border-[#E5E3DB] bg-white">
            ...
            <dl class="divide-y divide-[#EFEDE6] text-sm">
                ...
                <div class="flex justify-between px-8 py-4">
                    ...
                    <dd class="font-medium text-[#16213A]">Matematika</dd>
                </div>
                <div class="flex justify-between px-8 py-4">
            ...
            <div class="flex justify-end gap-4 border-t border-[#E5E3DB] px-8 py-5">
                ...
                <form action="{{ route('teachers.destroy', ['id' => $teacher['id']]) }}" method="POST" onsubmit="return confirm('Hapus data guru ini dari buku induk?')">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
