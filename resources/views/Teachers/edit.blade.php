...
@section('content')
    ...
    <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
        ...
        <div>
            ...
            <input type="text" id="nip" name="nip" value="Contoh: 198501012024"
        ...
        <div>
            ...
            <input type="text" id="name" name="name" value="Nama lengkap guru"
                class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm focus:border-[#A16207] focus:bg-white focus:outline-none">
        </div>
        ...
        <div>
            <label for="subject" class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Status</label>
